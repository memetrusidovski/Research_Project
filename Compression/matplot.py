...
ypoints.append(run(7, 1, 5))
ypoints.append(run(15, 3, 7))
ypoints.append(run(21, 1, 19))
ypoints.append(run(31, 1, 11))
ypoints.append(run(37, 5, 11))
ypoints.append(run(41, 9, 9))

xpoints = [7, 15, 21, 31, 37, 41]
